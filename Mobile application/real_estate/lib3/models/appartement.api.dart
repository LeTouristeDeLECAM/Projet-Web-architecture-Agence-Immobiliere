...
class AppartementApi {
  ...
  static Future<bool> addAppartement(Appartement appartement) async {
    ...
    var response = await http.post(url, headers: headers, body: jsonEncode(appartement.toString()));
    if (response.statusCode == 200) {
      return true;
    }
    return false;
  ...
  static Future<bool> updateAppartement(Appartement appartement) async {
    ...
    var response = await http.put(url, headers: headers, body: jsonEncode(appartement.toString()));
    if (response.statusCode == 200) {
      return true;
    }
    return false;
...
//     print ('jsonEncode(appartement.toString())');
//     print (jsonEncode(appartement.toString()));
